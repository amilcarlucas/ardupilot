...
class AutoTestCopter(AutoTest):
    ...
    def takeoff(self, alt_min=30, takeoff_throttle=1700):
        ...
        try:
            ...
            self.progress("Takeoff failed with %s" % type(ex).__name__)
            return False
    ...
    def land(self, timeout=60):
        ...
        try:
            ...
            self.progress("Land failed with %s" % type(ex).__name__)
            return False
    ...
    def hover(self, hover_throttle=1500):
        try:
            ...
            self.progress("Hover failed with %s" % type(ex).__name__)
            return False
    ...
    def loiter(self, holdtime=10, maxaltchange=5, maxdistchange=5):
        ...
        try:
            ...
            self.progress("Loiter failed with %s" % type(ex).__name__)
            return False
    ...
    def change_alt(self, alt_min, climb_throttle=1920, descend_throttle=1080):
        ...
        try:
            ...
            self.progress("change_alt failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_square(self, side=50, timeout=300):
        ...
        try:
            ...
            self.progress("fly_square failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_RTL(self, side=60, timeout=250):
        ...
        try:
            ...
            self.progress("fly_RTL failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_throttle_failsafe(self, side=60, timeout=180):
        ...
        try:
            ...
            self.progress("fly_throttle_failsafe failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_battery_failsafe(self, timeout=30):
        ...
        try:
            ...
            self.progress("fly_battery_failsafe failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_stability_patch(self,
        ...
        try:
            ...
            self.progress("fly_stability_patch failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_fence_test(self, timeout=180):
        ...
        try:
            ...
            self.progress("fly_fence_test failed with %s" % type(ex).__name__)
            # remove if we ever clear battery failsafe flag on disarm:
            self.mavproxy.send('arm check all\n')
            return False
    ...
    def fly_alt_max_fence_test(self, timeout=180):
        ...
        try:
            ...
            self.progress("fly_alt_max_fence_test failed with %s" % type(ex).__name__)
            # remove if we ever clear battery failsafe flag on disarm:
            self.mavproxy.send('arm check all\n')
            return False
    ...
    def fly_gps_glitch_loiter_test(self, timeout=30, max_distance=20):
        ...
        try:
            ...
            self.progress("fly_gps_glitch_loiter_test failed with %s" % type(ex).__name__)
            if self.use_map:
                self.show_gps_and_sim_positions(False)
            return False
    ...
    def fly_gps_glitch_auto_test(self, timeout=120):
        try:
            ...
            self.progress("fly_gps_glitch_auto_test failed with %s" % type(ex).__name__)
            if self.use_map:
                self.show_gps_and_sim_positions(False)
            return False
    ...
    def fly_simple(self, side=50, timeout=120):
        try:
            ...
            self.progress("fly_simple failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_super_simple(self, timeout=45):
        try:
            ...
            self.progress("fly_super_simple failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_circle(self, maxaltchange=10, holdtime=36):
        try:
            ...
            self.progress("fly_circle failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_auto_test(self):
        try:
            ...
            self.progress("fly_auto_test failed with %s" % type(ex).__name__)
            return False
    ...
    def fly_avc_test(self):
        try:
            ...
            self.progress("fly_avc_test failed with %s" % type(ex).__name__)
            return False
